...
const styles = StyleSheet.create({
  ...
  rim: { width: 64, height: 12, backgroundColor: '#ea580c', borderRadius: 6, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.2, shadowRadius: 4, elevation: 4 },
